  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        ...
        <h3>Connecting global events into a new narrative. <br/>By <a href="<?php echo esc_url( home_url( '/' ) ); ?>about/" title="More about Andrej Mrevlje and Yonder">Andrej Mrevlje</a>, delivered every Sunday.</h3>
