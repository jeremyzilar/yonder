  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        ...
        <h3>A weekly newsletter on the news from <a href="<?php echo get_permalink( get_page_by_path( 'about' ) ); ?>" title="More about Andrej Mrevlje and Yonder">Andrej Mrevlje</a>, <span>delivered every Sunday.</span></h3>
